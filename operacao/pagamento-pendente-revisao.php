...
<body id="app-container" class="menu-sub-hidden show-spinner">
    ...
    <main class="default-transition" style="opacity: 1;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <h1>Pagamentos pedentes de revisão</h1>
                        ...
                        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                            <ol class="breadcrumb pt-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">pagamentos pedentes</li>
                            </ol>
                        </nav>
    ...
    <script>
        ...
        function gerarRelatorio() {
            if (validarData()) {
                $.ajax({
                    url: '../utils/listarPagamentosPendenteRevisao.php',
                    type: 'POST',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        $('.data-table-features').DataTable({
                            ...
                            columns: [{
                                    ...
                                    return '<a href="editar-pagamento.php?atdid=' + row.atendimento.id_atendimento + '&pgtid='+ row.id_pagamento + '">' + data + '</a>'
                                }
                                },
                                {
                                    "data": "atendimento.cliente.telefone"
                                },
                                {
                                    "data": "atendimento.cliente.celular"
                                },
                                {
                                ...
                                },
                                {
                                    "data": "atendimento.cliente.nome_cliente",
                                    "render": function(data, type, row) {
                                        return '<a class="" href="editar-pagamento.php?atdid=' + row.atendimento.id_atendimento + '&pgtid='+ row.id_pagamento + '">Editar</a>';
                                }}
                            ],
