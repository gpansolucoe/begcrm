                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="../utils/alterarPagamento.php">
                                ...
                                <div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-1">
                                            <button id="submit" type="submit" onclick="atualizarStatus(1)" class="btn btn-success d-block mt-3 mb-3">Confirmar Revisão</button>
                                        </div>
                                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data != false) {
                        ...
                        $('#inputDataPagamento').val(jsonData.data_pagamento);
                        $('#inputDataPasta').val(jsonData.data_pasta);
