            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data != false) {
                        ...
                        $("#inputCelular").val(jsonData.cliente.telefone);
                        $("#inputEmail").val(jsonData.cliente.email);
                        $("#inputEndereco").val(jsonData.cliente.endereco);
                        $("#inputNumero").val(jsonData.cliente.numero);
                        $("#inputComplemento").val(jsonData.cliente.complemento);
                        $("#inputBairro").val(jsonData.cliente.bairro);
                        $("#inputCidade").val(jsonData.cliente.cidade);
                        $("#inputEstado").val(jsonData.cliente.estado);
