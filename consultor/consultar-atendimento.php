...
<head>
    <meta charset="UTF-8">
    <title>Gpan Sistemas - Consultar Atendimento</title>
...
<body id="app-container" class="menu-sub-hidden show-spinner">
                            ...
                            <div class="d-block d-md-inline-block">
                                <div class="btn-group float-md-left mr-1 mb-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="#">Fechado com boleto</a>
                                        <a class="dropdown-item" href="#">Sem contato</a>
                                        <a class="dropdown-item" href="#">Em proposta</a>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function criarLinhaLista(item) {
            if (item.consultor.id_usuario == sessionStorage.getItem("id_usuario")) {
                var linha = '<div class="card d-flex flex-row mb-3">' +
                    ...
                    '<a href="editar-atendimento.php?atdid=' + item.id_atendimento + '" class="w-30 w-sm-100">' +
                ...
                var linha = '<div class="card d-flex flex-row mb-3">' +
                    ...
                    '<p class="list-item-heading mb-1 truncate">' + item.cliente.nome_cliente + '</p>' +
                    '</a>' +
                    '<p class="mb-1 text-muted text-small w-10 w-sm-100"><i class="simple-icon-phone"></i> ' + item.cliente.telefone + '</p>' +
                    '<p class="mb-1 text-muted text-small w-10 w-sm-100"><i class="simple-icon-screen-smartphone"></i> ' + item.cliente.celular + '</p>' +
                    '<p class="mb-1 text-muted text-medium w-40 w-sm-100"><i class="simple-icon-people"></i> ' + item.consultor.nome + '</p>' +
                    '<p class="mb-1 text-muted text-small w-15 w-sm-100"><i class="simple-icon-clock"></i> ' + formatarData(item.dt_inclusao) + '</p>' +
                    '<p class="mb-1 text-muted text-small w-15 w-sm-100"><i class="simple-icon-calendar"></i> ' + formatarData(item.dt_agendamento) + '</p>' +
                    '<div class="w-15 w-sm-100">' +
        ...
        //$.getJSON("https://viacep.com.br/ws/05572100/json/", function(data) {
