            ...
            <div class="col-lg-12 col-12 mb-4">
               <div class="card mb-4">
                  <div class="card-body">
                     ...
                     <form method="post" id="form" action="../utils/atualizarAtendimento.php">
                        <div class="form-row">
...
<script>
    $('#form').submit(function(event) {
    	$("#inputMidia").prop('disabled', false);
    	$(this).submit(); 
    });
   ...
   $.getJSON("../utils/listarServicosAtivos.php", function(data) {
      ...
      $.getJSON("../utils/listarConsultoresAtivos.php", function(data) {
         if (data != false) {$("#inputMidia").prop('disabled', false);
            var jsonData = data.data;;
            $.each(jsonData, function(key, value) {
