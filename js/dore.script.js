    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("salesChart")) {
        ...
        var myChart = new Chart(salesChart, {
          ...
          data: {
            labels: ["Adriele Nascimento", "Alexandre Ferrari", "Ana Julia", "Anderson Silva", "Andrea Velozo", "Atila Oliveira", "Bernardo Rezende", "Bruna Moretti", "Bueno", "Celia Bittencourt", "Cynthia Galdino", "Daniel", "Dayane Freitas", "Diogo Fernandes", "Elaine Sousa", "Felipe Martins", "Gabriel Moraes ", "Henrique Queiroz", "Jade Machado", "Jefferson Santos", "Karla Camila", "Keila Leme", "Kelter Oliveira", "Lucas Candido", "Luiza Costa", "Maia Magalhães", "Mariangela Souza", "Marta Souza", "Neuma Carvalho", "Nicolas Onykoro", "Paula Miranda", "Rayane Torres", "Regina Lopez", "Sara Gonçalves", "Suellen Tavares", "Thatiane Martins", "Ton Fonseca", "Vanessa Oliveira", "Venancio Silva", "Viana", "Victoria Rafaely", "Vitor Marcelino"],
            datasets: [
              {
                label: "",
                data: [54, 63, 60, 65, 60, 68, 60],
