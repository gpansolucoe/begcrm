			...
			<div class="navbar-right">
				...
				<div class="user d-inline-block">
					<button class="btn btn-empty p-0" type="button" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false">
						<span class="name">'.$_SESSION["nome_usuario"].'</span>
						<span>
							<img alt="Profile Picture" src="../img/diamond.svg" />
						</span>
					</button>

					<div class="dropdown-menu dropdown-menu-right mt-3">
						<a class="dropdown-item" href="meu-perfil.php">Meus Dados</a>
						<a class="dropdown-item" href="#">Suporte</a>
						<a class="dropdown-item" href="../utils/sair.php">Sair</a>
					</div>
				</div>
			</div>
		</nav>';
	}else{
		header("Location: ../utils/sair.php");
	}
}else{
	header("Location: ../utils/sair.php");
}
