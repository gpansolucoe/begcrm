...
<body id="app-container" class="menu-sub-hidden show-spinner">
    ...
    <main>
        <div class="container-fluid">
            <div class="row  ">
                <div class="col-12">
                    <h1>Aprovar Pagamento</h1>
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            <li class="breadcrumb-item">
                                <a href="Dashboard.Home.php">Home</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Aprovar Pagamento</li>
                        </ol>
                    </nav>
                ...
                <div class="col-lg-12 col-12 mb-4">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="underline mb-3">Aprovar Pagamento</h5>
                            <form method="post" action="../utils/aprovarPagamento.php">
                                <div class="form-row">
                                    <div class="form-row">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-1">
                                                <button id="submit" type="submit" onclick="atualizarStatus(4)" class="btn btn-success d-block mt-3 mb-3">Aprovar</button>
                                            </div>
                                            <div class="form-group col-md-1">
