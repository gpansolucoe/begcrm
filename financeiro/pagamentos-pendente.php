...
<head>
    <meta charset="UTF-8">
    <title>Gpan Sistemas - Consulta</title>
    ...
    <main class="default-transition" style="opacity: 1;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <h1>Pagamentos sem Comprovante</h1>
                    ...
                    $('.data-table-features').DataTable({
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                "render": function(data, type, row) {
                                    if(data == null){
                                        return '<a class="ml-5" href="editar-atendimento.php?atdid=' + row.id_atendimento + '"><i class="simple-icon-eye"></i></a>';
                                    }else{
                                        return '<a href="editar-atendimento.php?atdid=' + row.id_atendimento + '"><i class="simple-icon-eye"></i></a>'
                                    }
