...
<body id="app-container" class="menu-sub-hidden show-spinner">
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="linha-relatorio" style="display:none;">
                <div class="col-lg-12 col-md-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-4">Relatório Pagamentos Aprovados</h5>
                            <div class="row mb-4">
                                <div class="col-sm-12">
    ...
    <script>
        ...
        function gerarGrafico() {
            //if (validarData()) {
            $.ajax({
                url: '../utils/relatorioTotalPagamentosAprovados.php',
                type: 'POST',
                data: {
        ...
        function gerarRelatorio() {
            //if (validarData()) {
            $.ajax({
                url: '../utils/listarPagamentosAprovados.php',
                type: 'POST',
                data: {
                    dataIni: $('input[name=dataInicio]').val(),
                    dataFim: $('input[name=dataFim]').val(),
                ...
                success: function(data) {
                    ...
                    if (data != false) {
                        ...
                        $('.data-table-features').DataTable({
                            ...
                            columns: [{
                                    "data": "atendimento.cliente.nome_cliente"
                                },
                                {
                                    "data": "atendimento.cliente.cpf"
                                },
                                {
                                    "data": "numero_interno"
                                },
                                ...
                                {
                                    "data": "atendimento.valor_proposta"
                                },
                                {
                                    "data": "valor_entrada"
                                },
                                ...
                                {
                                    "data": "atendimento.consultor.nome"
                                },
                                {
                                    "data": "forma_pagamento.nome_forma_pagamento"
                                },
                                {
                                    "data": "autenticacao"
                                },
                                ...
                                {
                                    "data": "atendimento.midia.nome_midia"
                                },
                                {
                                    "data": "atendimento.servico.nome_servico"
                                }
                            ],
        ...
        function popularGrafico(data) {
            ...
            $.each(data.data, function(index, valor) {
                labels.push(valor.nome_servico);
                quantidade.push(valor.valor_total);
                soma = soma + parseInt(valor.valor_total);
            });

            inserirRelatorioHTML("TOTAL: " + soma.toLocaleString('pt-br', {
                style: 'currency',
                currency: 'BRL'
            }), 1);
