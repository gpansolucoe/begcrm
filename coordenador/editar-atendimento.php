            ...
            <div class="col-lg-12 col-12 mb-4">
               <div class="card mb-4">
                  <div class="card-body">
                     ...
                     <form method="post" action="../utils/atualizarAtendimento.php">
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <input type="email" class="form-control" id="inputEmail" name="inputEmail" autocomplete="off" onblur="validacaoEmail(this)" value="" placeholder="Email">
                        ...
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <input type="text" class="form-control" id="inputCpf" name="inputCpf" value="" placeholder="CPF" onblur="mascara(this,cpfCnpj)" maxlength="14" onkeypress="mascara(this,cpfCnpj)">
                           </div>
                           <div class="form-group col-md-2">
			   ...
			   -->
                        ...
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <select id="inputMidia" name="inputMidia" class="form-control" required>
                                 <option value="" selected="">Selecione...</option>
                              </select>
                           </div>
                           <div class="form-group col-md-2">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <input type="text" id="inputDataAgendamento" name="inputDataAgendamento" class="form-control datepicker">
                           </div>
                        ...
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-2">
                              ...
                              <select id="inputConsultor" name="inputConsultor" class="form-control" required>
                                 <option value="" selected="">Selecione...</option>
                              </select>
                           </div>
                        </div>
                        ...
                        <button id="submit" type="submit" class="btn btn-primary mt-3 mb-3">Salvar</button>
			<a href="../print.php?atdid=<?php echo $_GET["atdid"] ?>" target=”_blank” rel="noopener noreferer" class="btn btn-primary  mt-3 mb-3">Imprimir como B&G</a>
			<a href="../print.php?atdid=<?php echo $_GET["atdid"] ?>&oba=true" target=”_blank” rel="noopener noreferer" class="btn btn-primary  mt-3 mb-3">Imprimir como O Bom Acordo</a>
...
<script>
                           ...
                           success: function(data) {
                              if (data != false) {
                                 ...
                                 if(jsonData.cliente.cpf.length > 14){
                                    $("#inputCnpj").val(jsonData.cliente.cpf);
                                 }else{
                                 ...
                                 if (jsonData.fluxo_atendimento.nome != "CANCELADO" && jsonData.fluxo_atendimento.nome != "PERCA") {
  ...
  $('#inputTelefone, #inputCelular').blur(function(event) {
    $(this).mascaraTel(this, $(this).val());
    console.log("blur");

  });

  $("#inputTelefone, #inputCelular").keypress(function(){
    $(this).mascaraTel(this, $(this).val());
    console.log("Keypress");
  });

  (function($){
     $.fn.mascaraTel = function(o, f) {
        setTimeout(function() {
          var v = $(this).mphone(o.value);
          if (v != o.value) {
            o.value = v;
          }
        }, 1);
