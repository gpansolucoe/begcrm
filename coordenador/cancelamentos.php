...
<head>
    <meta charset="UTF-8">
    <title>Gpan Sistemas - Cancelamentos</title>
...
<body id="app-container" class="menu-sub-hidden show-spinner">
    ...
    <main class="default-transition" style="opacity: 1;">
        ...
        <div class="modal fade" id="modalConfirmacao" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="../utils/excluirAtendimento.php">
                        <div class="modal-body">
                            <p>Atenção, você esta prestes a excluir este lead e tudo atrelado a esse telefone/celular. Você tem certeza que deseja fazer isso? </p>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" id="idAtendimento" name="idAtendimento" value="">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                            <button type="submit" class="btn btn-primary">Confirmo, pode excluir</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        function criarLinhaLista(item) {
            var linha = '<div class="card d-flex flex-row mb-3">' +
                ...
                '<a href="#" onclick="exibirMotivo(\'' + item.motivo_fluxo_atendimento + '\');" data-toggle="modal" data-target=".bd-example-modal-lg" class="w-40 w-sm-100">' +
                ...
                '<a class="dropdown-item" data-toggle="modal" data-target="#modalConfirmacao" href="#" onclick="excluirAtendimento(' + item.id_atendimento + ');" >Excluir Lead</a>';
            linha = linha + '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
