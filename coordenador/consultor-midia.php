...
<body id="app-container" class="menu-sub-hidden show-spinner">
    ...
    <main class="default-transition" style="opacity: 1;">
        <div class="container-fluid">
            ...
            <div class="row" id="linha-relatorio">
                <div class="col-lg-12 col-md-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-4">Relatório Consultor x Midia</h5>
                            <div class="row mt-5">
                                <div class="col-sm-10">
                                    <label>Data</label>
                                    <div class="input-daterange input-group mb-4 mt-40 w-40" id="datepicker">
                                        <input type="text" class="input form-control" id="dataInicio" name="dataInicio" placeholder="Inicio">
                                        <span class="input-group-addon"></span>
                                        <input type="text" class="input form-control" id="dataFim" name="dataFim" placeholder="Fim">
    ...
    <script>
        ...
        function gerarRelatorio() {
           // if (validarData()) {
                $.ajax({
                    url: '../utils/relatorioConsultorMidia.php',
                    type: 'POST',
                    data: {
        ...
        function popularGrafico(data) {
            ...
            $.each(data.data, function(index, valor) {
                labels.push(valor.nome_consultor);
                quantidade.push(valor.valor_total);
                 soma = soma + parseInt(valor.valor_total);
            });

            inserirRelatorioHTML($( "#inputMidia option:selected" ).text() + " : " + soma.toLocaleString('pt-br', {
                                        style: 'currency',
                                        currency: 'BRL'
                                        }), 1);
